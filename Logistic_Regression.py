...
if False:
    ...
    model = LogisticRegression(multi_class='multinomial', class_weight=None)
    ...
    best_params = {'solver': 'newton-cg', 'max_iter': 1000, 'penalty': 'l2', 'C': 10}

# Ajustar el modelo con los mejores hiperparámetros
best_model = LogisticRegression(**best_params, multi_class='multinomial', class_weight=None)
